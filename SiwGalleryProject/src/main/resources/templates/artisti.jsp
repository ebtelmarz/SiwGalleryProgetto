...
<body>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand">GALLERIA D'ARTE</a>
		</div>
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				<li><a href="index.html">HOME</a></li>
				<li><a href="artisti.jsp">ARTISTI</a></li>
				<li><a href="OpereAutore.jsp">OPERE</a></li>
	...
	<div id="band" class="container text-center">
		<h3>"L'arte scuote dall'anima la polvere accumulata nella vita di
			tutti i giorni."</h3>
		<h5>-Pablo Picasso</h5>
		<br>
		...
		<c:forEach var="autore" items="${autori}">
			<a href="autore?id=${autore.id}" class="btn btn-block btn-lg btn-default">${autore.nome}</a>
